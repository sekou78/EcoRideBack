 ...
 */
final class Version20250421170823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE avis ADD employes_id INT DEFAULT NULL, DROP valide_par_employee
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE avis ADD valide_par_employee TINYINT(1) NOT NULL, DROP employes_id
        SQL);
    }
}
